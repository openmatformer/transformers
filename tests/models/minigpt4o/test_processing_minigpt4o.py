...
from transformers import Minigpt4oTokenizerFast, SiglipImageProcessorFast, is_speech_available
...
if is_speech_available():
    from transformers.models.minigpt4o import Minigpt4oAudioFeatureExtractor, Minigpt4oProcessor
...
class Minigpt4oProcessorTest(unittest.TestCase):
    def setUp(self):
    ...
    def get_tokenizer(self, **kwargs):
        return Minigpt4oTokenizerFast.from_pretrained(self.model_id, **kwargs)

    def get_feature_extractor(self, **kwargs):
        return Minigpt4oAudioFeatureExtractor.from_pretrained(self.model_id, **kwargs)
    ...
    def test_save_load_pretrained_default(self):
        ...
        processor = Minigpt4oProcessor.from_pretrained(self.tmpdirname)

        self.assertIsInstance(processor.tokenizer, Minigpt4oTokenizerFast)
        ...
        self.assertIsInstance(processor.feature_extractor, Minigpt4oAudioFeatureExtractor)
    ...
    def test_save_load_pretrained_additional_features(self):
        ...
        processor = Minigpt4oProcessor.from_pretrained(

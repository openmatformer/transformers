...
from transformers.models.minigpt4o import Minigpt4oAudioFeatureExtractor
...
class Minigpt4oAudioFeatureExtractionTester:
    def __init__(
        self,
        parent,
        batch_size=7,
...
class Minigpt4oAudioFeatureExtractionTest(SequenceFeatureExtractionTestMixin, unittest.TestCase):
    feature_extraction_class = Minigpt4oAudioFeatureExtractor

    def setUp(self):
        self.feat_extract_tester = Minigpt4oAudioFeatureExtractionTester(self)

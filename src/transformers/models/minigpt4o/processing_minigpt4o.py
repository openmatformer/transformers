...
class Minigpt4oImagesKwargs(ImagesKwargs):
...
class Minigpt4oProcessorKwargs(ProcessingKwargs, total=False):
    audio_kwargs: AudioKwargs
    images_kwargs: Minigpt4oImagesKwargs
    _defaults = {
        "text_kwargs": {
            "padding": False,
        },
...
class Minigpt4oProcessor(ProcessorMixin):
    """
    A processor for Minigpt4o, wrapping the full capabilities of a feature extractor, image processor, and tokenizer

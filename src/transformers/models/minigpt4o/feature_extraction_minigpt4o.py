...
class Minigpt4oAudioFeatureExtractor(SequenceFeatureExtractor):
    """An audio feature extractor for Minigpt4o Universal Speech Models https://arxiv.org/abs/2303.01037.
...
__all__ = ["Minigpt4oAudioFeatureExtractor"]

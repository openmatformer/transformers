...
class Minigpt4oTextConfig(PretrainedConfig):
    ...
    Minigpt4oTextModel model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a similar configuration to that of the Minigpt4o base model.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 200_000):
    ...
    >>> # Initializing a Minigpt4oText gemma3n_text-E4B style configuration
...
class Minigpt4oAudioConfig(PretrainedConfig):
    ...
    an `Minigpt4oAudioEncoder` model according to the specified arguments, defining the model architecture. Instantiating
    a configuration with the defaults will yield a similar configuration to that of the Minigpt4o base model.

    Configuration objects that inherit from [`Minigpt4oAudioConfig`] and can be used to control the model outputs. Read
    the documentation from [`Minigpt4oAudioConfig`] for more information.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 128):
            ...
            included in the `Minigpt4oTextModel` to provide, e.g., the end of audio and audio soft token placeholder
            tokens when converting `input_ids` to embeddings in the `Minigpt4oForConditionalGeneration` model.
    ...
    ```python
    >>> from transformers import Minigpt4oAudioConfig, Minigpt4oAudioEncoder

    >>> # Initializing a Minigpt4oAudioEncoder gemma3n_audio-E4B-style configuration
    >>> configuration = Minigpt4oAudioConfig()

    >>> # Initializing a model from the gemma3n_audio-E4B style configuration
    >>> model = Minigpt4oAudioEncoder(configuration)
...
class Minigpt4oVisionConfig(PretrainedConfig):
    ...
    Instantiating a configuration with the defaults will yield a similar configuration to that of the Minigpt4o base
    vision tower.

    Configuration objects inherit from [`Minigpt4oVisionConfig`] and can be used to control the model outputs. Read the
    documentation from [`Minigpt4oVisionConfig`] for more information.
    ...
    Example:
    ```python
    >>> from transformers import Minigpt4oVisionConfig, TimmWrapper

    >>> # Initializing a TimmWrapper gemma3n_vision-E4B-style configuration
    >>> configuration = Minigpt4oVisionConfig()
...
class Minigpt4oConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers import Minigpt4oForConditionalGeneration, Minigpt4oConfig, Minigpt4oTextConfig

    >>> # Initializing a MobileNet vision config, which is loaded from TIMM
    >>> vision_config = Minigpt4oVisionConfig()

    >>> # Initializing a Minigpt4o Audio config
    >>> audio_config = Minigpt4oAudioConfig()

    >>> # Initializing a Minigpt4o Text config
    >>> text_config = Minigpt4oTextConfig()

    >>> # Initializing a Minigpt4o gemma-3-4b style configuration
    >>> configuration = Minigpt4oConfig(text_config, vision_config, audio_config)

    >>> # Initializing a model from the gemma-3-4b style configuration
    >>> model = Minigpt4oTextConfig(configuration)
...
__all__ = ["Minigpt4oAudioConfig", "Minigpt4oConfig", "Minigpt4oTextConfig", "Minigpt4oVisionConfig"]

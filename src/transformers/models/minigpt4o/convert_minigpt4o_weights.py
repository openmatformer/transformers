# coding=utf-8
# Copyright 2025 Dustin Loring. HuggingFace Inc. team. All rights reserved.
#
#
...
python src/transformers/models/minigpt4o/convert_minigpt4o_weights.py \
    --variant='minigpt4o_e4b' \
    --tokenizer_path="$HOME/tokenizers/minigpt4o-tokenizer.model" \
    --checkpoint_path="$HOME/checkpoints/minigpt4o-orbax/" \
    --output_path="$HOME/checkpoints/minigpt4o-safetensors/"
"""
...
_VARIANTS: Mapping[str, Minigpt4oConfig] = {
    _VARIANT_GEMMA_3_2B: Minigpt4oConfig(
    ...
    _VARIANT_GEMMA_3_4B: Minigpt4oConfig(
        text_config=Minigpt4oTextConfig(),
        vision_config=Minigpt4oVisionConfig(),
        audio_config=Minigpt4oAudioConfig(),
    ),
...
def convert(checkpoint_path: str, config: Minigpt4oConfig) -> dict[str, torch.Tensor]:
...
def main(*args):
    ...
    with accelerate.init_empty_weights():
        model = Minigpt4oForConditionalGeneration(config=config)
    ...
    tokenizer = Minigpt4oTokenizerFast(
    ...
    feature_extractor = Minigpt4oAudioFeatureExtractor()

...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("minigpt4o", "MiniGPT4OConfig"),
        ("minigpt4o_audio", "MiniGPT4OAudioConfig"),
        ("minigpt4o_text", "MiniGPT4OTextConfig"),
        ("minigpt4o_vision", "MiniGPT4OVisionConfig"),
        ("git", "GitConfig"),
        ("glm", "GlmConfig"),
        ("glm4", "Glm4Config"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("minimax", "MiniMax"),
        ("minigpt4o", "MiniGPT4O"),
        ("minigpt4o_audio", "MiniGPT4O Audio"),
        ("minigpt4o_text", "MiniGPT4O Text"),
        ("minigpt4o_vision", "MiniGPT4O Vision"),
        ("mistral", "Mistral"),
        ("mistral3", "Mistral3"),
        ("mixtral", "Mixtral"),
        ("mlcd", "MLCD"),
